...
Note: in some binary packaged versions of the library, buildVideoIO has 
been omitted.  As long as the binary files are compatible with your 
version of Matlab, buildVideoIO.m is not needed.  If you encounter any
problems, use a full source package and build the libraries using the
appropriate installation document (INSTALL.dshow.html or 
INSTALL.ffmpeg.txt).
